...
export interface CadProposal { id: string; request: string; source: "LOCAL_MODEL" | "DETERMINISTIC"; status: "READY" | "BLOCKED" | "COMPLETED"; baseRevision?: number; changes: CadProposalChange[]; citations?: Array<{ excerptId: string; evidenceId: string; source: string }>; message?: string; createdAt: string; }
